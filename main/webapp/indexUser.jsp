			...
			<div class="col-lg-3 d-none d-lg-block">
				...
				<nav
					...
					<div class="navbar-nav w-100 overflow-hidden" style="height: 410px">
						...
						<a href="zing.jsp" class="nav-item nav-link">ZING</a> 
						<a href="vcoin.jsp"class="nav-item nav-link">VCOIN</a> 
						<a href="garena.jsp"class="nav-item nav-link">GARENA</a> 
						<a href="gate.jsp"class="nav-item nav-link">GATE</a> 
						<a href="vgplay.jsp"class="nav-item nav-link">VGPLAY</a>
					</div>
				</nav>
			</div>
			<div class="col-lg-9">
				<nav
					...
					<div class="collapse navbar-collapse justify-content-between"
						...
						<div class="navbar-nav mr-auto py-0">
							<a href="indexUser.jsp" class="nav-item nav-link active">Trang chủ</a> 
							<a href="check.jsp" class="nav-item nav-link">Giỏ hàng</a> 
		...
		<div class="row px-xl-5 pb-3">
			<div class="col-lg-4 col-md-6 pb-1">
				<div class="cat-item d-flex flex-column border mb-4"
					...
					<a href="zing.jsp" class="cat-img position-relative overflow-hidden mb-3">
			...
			<div class="col-lg-4 col-md-6 pb-1">
				<div class="cat-item d-flex flex-column border mb-4"
					style="padding: 30px;">
					<p class="text-right">6 Sản phẩm</p>
					<a href="garena.jsp" class="cat-img position-relative overflow-hidden mb-3">
			...
			<div class="col-lg-4 col-md-6 pb-1">
				<div class="cat-item d-flex flex-column border mb-4"
					style="padding: 30px;">
					<p class="text-right">6 Sản phẩm</p>
					<a href="vcoin.jsp" class="cat-img position-relative overflow-hidden mb-3">
			...
			<div class="col-lg-4 col-md-6 pb-1">
				<div class="cat-item d-flex flex-column border mb-4"
					style="padding: 30px;">
					<p class="text-right">6 Sản phẩm</p>
					<a href="gate.jsp" class="cat-img position-relative overflow-hidden mb-3">
		...
		<div class="container-fluid bg-secondary text-dark mt-5 pt-5">
			<div class="row px-xl-5 pt-5">
				<div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
					...
					<p>Giúp bạn nạp nhanh hơn thuận tiện hơn. Chúng tôi luôn muốn mang
