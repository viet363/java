								...
								<tr>
									...
									<td>
										...
										<button type="button" class="btn btn-primary btn-sm"
											data-toggle="modal"
											data-target="#updateModal${user.username}">Cập nhật
										</button>
									</td>
								</tr>
								<!-- Update user modal -->
								<div class="modal fade" id="updateModal${user.username}"
									tabindex="-1" role="dialog"
									aria-labelledby="updateModalLabel${user.username}"
									aria-hidden="true">
									<div class="modal-dialog" role="document">
										<div class="modal-content">
											<div class="modal-header">
												<h5 class="modal-title"
													id="updateModalLabel${user.username}">Cập nhật thông
													tin người dùng</h5>
											...
											<div class="modal-body">
												...
												<form action="user-list" method="post">
													...
													<div class="form-group">
														<label for="newEmail">Email mới:</label> <input
															type="email" class="form-control" id="newEmail"
															name="newEmail" required>
													</div>
													<div class="form-group">
														<label for="newType">Loại người dùng mới:</label> <input
															type="text" class="form-control" id="newType"
															name="newType" required>
													</div>
													<div class="form-group">
														<label for="newSDT">Số điện thoại mới:</label> <input
															type="text" class="form-control" id="newSDT"
															name="newSDT" required>
													</div>
